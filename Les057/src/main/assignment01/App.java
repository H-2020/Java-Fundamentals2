...
public class App {
    ...
    public static void main(String[] args) {
        ...
        // EMPLOYEE_6
        int employee6id = 6;
        String employee6FirstName = "Elon";
        String employee6LastName = "Desk";
        String employee6Department = "Marketing guy";
        double employee6Salary = 1_000_000_000;
        String employee6Email = "elon.desk@intecbrussel.be";
        long employee6PhoneNumber = 667711102L;
        boolean employee6StillEmployed = false;
        boolean employee6Outsourced = true;

        employeeList.addEmployeeId(idColumnArray,2);

        System.out.println("***********************************");
        employeeList.removeEmployeeId(idColumnArray);
